...
// 3. La consulta de productos - Filtrando por id_categoria para no traer el logo (ID 6)
$sql = "SELECT * FROM productos WHERE id_categoria != 6 ORDER BY RAND()";
$resultado = mysqli_query($conexion, $sql);

// 4. Verificación de consulta
if (!$resultado) {
...
<head>
    ...
    <title>Todos los Productos | D' Fiordaliza Style</title>
...
<main class="container productos">
    <div class="grid">
        <?php if ($resultado && mysqli_num_rows($resultado) > 0): ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <p class="no-products">No hay accesorios registrados.</p>
        <?php endif; ?>
    </div>
</main>
