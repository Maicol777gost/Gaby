...
// 1. Consulta para Damas (Categoría 1)
$sql_productos = "SELECT * FROM productos WHERE id_categoria = 1 ORDER BY RAND()";
...
<head>
    ...
    <title>Ropa de Damas | D' Fiordaliza Style</title>
...
<main class="container productos">
    <div class="grid">
        <?php if ($resultado && mysqli_num_rows($resultado) > 0): ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <p class="no-products">No hay ropa de damas registrada.</p>
        <?php endif; ?>
    </div>
</main>
