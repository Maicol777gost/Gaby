...
// 1. Consulta para Calzado (Categoría 4)
$sql_productos = "SELECT * FROM productos WHERE id_categoria = 4 ORDER BY RAND()";
...
<head>
    ...
    <title>Calzados | D' Fiordaliza Style</title>
...
<main class="container productos">
    <div class="grid">
        <?php if ($resultado && mysqli_num_rows($resultado) > 0): ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <p class="no-products">No hay calzados registrados.</p>
        <?php endif; ?>
    </div>
</main>
