...
// 1. Consulta para Perfumes (Categoría 8)
$sql_productos = "SELECT * FROM productos WHERE id_categoria = 8 ORDER BY RAND()";
...
<head>
    ...
    <title>Perfumes| D' Fiordaliza Style</title>
...
<main class="container productos">
    <div class="grid">
        <?php if ($resultado && mysqli_num_rows($resultado) > 0): ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <p class="no-products">No hay perfumes registrados.</p>
        <?php endif; ?>
    </div>
</main>
