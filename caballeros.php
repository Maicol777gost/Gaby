...
// 1. Consulta para Caballeros (Categoría 2)
$sql_productos = "SELECT * FROM productos WHERE id_categoria = 2 ORDER BY RAND()";
...
<head>
    ...
    <title>Ropa de Caballeros | D' Fiordaliza Style</title>
...
<main class="container productos">
    <div class="grid">
        <?php if ($resultado && mysqli_num_rows($resultado) > 0): ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <p class="no-products">No hay ropa de caballeros registrada.</p>
        <?php endif; ?>
    </div>
</main>
