...
// 1. Consulta para Carteras (Categoría 7)
$sql_productos = "SELECT * FROM productos WHERE id_categoria = 7 ORDER BY RAND()";
...
<head>
    ...
    <title>Carteras | D' Fiordaliza Style</title>
...
<main class="container productos">
    <div class="grid">
        <?php if ($resultado && mysqli_num_rows($resultado) > 0): ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <p class="no-products">No hay carteras registradas.</p>
        <?php endif; ?>
    </div>
</main>
